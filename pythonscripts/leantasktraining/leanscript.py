...
import sklearn
import pandas as pd
os.environ["WANDB_PROJECT"]="LEANQWEN" # Set your project name for WandB
...
# Split temp into validation (10%) and test (10%)
    ...
    model.save_pretrained("trainedmodels/LQ3FULL") 
    tokenizer.save_pretrained("trainedmodels/LQ3FULL")
