...
os.environ["WANDB_PROJECT"]="demiQwen2.5DIFFPARA"
def load_model():
    model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = "trainedmodels/NPSQwenearlystop1",
...
def init_trainer(model, tokenizer, dataset, formatting_p_func):
    ...
    formatting_func= formatting_p_func,
    max_seq_length = max_seq_length,
    dataset_num_proc = 2,
...
def main():
    ...
    model.save_pretrained("DQ1newpara") 
    tokenizer.save_pretrained("DQ1newpara")
